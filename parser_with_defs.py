...
def buysomegoods():
    url = "https://vkusvill.ru/goods/supermarket/"
    driver.get(url)
    WebDriverWait(driver, 10).until(expected_conditions.presence_of_element_located((By.CLASS_NAME, "CartButton__inner")))
    driver.find_element(By.CLASS_NAME,"CartButton__inner").click()
    driver.save_screenshot("buysomegoods.png")

def enteraddress():
    url = "https://vkusvill.ru/"
    driver.get(url)
    driver.find_element(By.XPATH, "/html/body/div[2]/header/div/div[1]/div/div/div[5]/div/div[2]/div[1]/div/div/a/div[2]").click()
    ...
    time.sleep(3)
    driver.save_screenshot("enteraddress.png")
...
def getgreenlabels():
    ...
    driver.save_screenshot("getgreenlabels.png")
    driver.quit()
